                ...
                {isLoggedIn && <div className='flex items-center gap-3 relative'>
                    ...
                    {isShowMenu && <div className='absolute min-w-200 top-full bg-white shadow-md rounded-md p-4 right-0 flex flex-col'>
                        {menuManage.map(item => {
                            return (
                                <Link
                                    className='hover:text-red-500 flex items-center gap-2 text-blue-600 border-b border-gray-200 py-2'
                                    key={item.id}
                                    to={item?.path}
                                >
                                    {item?.icon}
                        ...
                        <span
                            className='cursor-pointer hover:text-red-500 text-blue-500 py-2 flex items-center gap-2'
                            onClick={() => {
                                setIsShowMenu(false)
